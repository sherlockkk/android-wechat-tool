...
//        one.setOnCheckedChangeListener(this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                animator.start();
                if (open) {
                    ObjectAnimator anim = ObjectAnimator.ofFloat(controls, "alpha", 1f, 0f, 1f);
                    ...
                    windowManager.updateViewLayout(window, layoutParams);
                    open = true;
                    ObjectAnimator.ofFloat(controls, "alpha", 1f, 0f, 1f).setDuration(1000).start();
                }
            }
        });
        super.onCreate();
    ...
    public void onCheckedChanged(SwitchButton view, boolean isChecked) {
        switch (view.getId()) {
            case R.id.money:
                if (isChecked) {
                    Toast.makeText(this, "抢红包开启", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(this, "抢红包关闭", Toast.LENGTH_SHORT).show();
